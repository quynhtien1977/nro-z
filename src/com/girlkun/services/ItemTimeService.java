...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseBanhChung) {
            sendItemTime(player, 7080, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimeBanhChung)) / 1000));
        }
        if (player.itemTime.isUseBanhTet) {
            sendItemTime(player, 7079, (int) ((TIME_MAY_DO- (System.currentTimeMillis() - player.itemTime.lastTimeBanhTet)) / 1000));
        }
