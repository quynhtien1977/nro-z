                ...
                if (canOpenNpc(player)) {
                    if (mapId == 0) {
                        ...
                        if (now > nguhs.TIME_OPEN_NHS && now < nguhs.TIME_CLOSE_NHS) {
                            this.createOtherMenu(player, 0, "Ngũ Hàng Sơn x2 TNSM\b|1|Từ 1tỷ5 SM dến 100 Tỷ SM?", "Vào", "Từ chối");
                        } else {
                   ...
                   if (mapId == 122) {
                       this.createOtherMenu(player, 0, "Xia xia thua phùa\b|7|Thí chủ đang có: " + player.NguHanhSonPoint + " điểm ngũ hành sơn\b|1|Thí chủ muốn đổi cải trang không?\n 10000 điểm : Cải trang x4 chưởng\n 5000 điểm : Cải trang x3 chưởng\n 2000 điểm : Cải trang ngẫu nhiên HSD hoặc vĩnh viễn", "Cải trang x4 chưởng", "Cải trang x3 chưởng", "Cải trang ngẫu nhiên", "Top Ngu Hanh Son", "No");
                    }
                }
            }
                    ...
                    if (mapId == 122) {
                        if (select == 0) {
                            if (player.NguHanhSonPoint >= 10000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Chúc Mừng Bạn Đổi "+item.Name()+" Thành Công !");
                                InventoryServiceNew.gI().sendItemBags(player);
                            } else {
                                Service.getInstance().sendThongBao(player, "Không đủ điểm, bạn còn " + (10000 - player.NguHanhSonPoint) + " điểm nữa");
                            }
                        }
                        if (select == 1){
                            if (player.NguHanhSonPoint >= 5000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Không đủ điểm, bạn còn " + (5000 - player.NguHanhSonPoint) + " điểm nữa");
                            }
                        }
                        if (select == 2){
                            if (player.NguHanhSonPoint >= 2000){
                                ...
                                Service.getInstance().sendThongBao(player, "Không đủ điểm, bạn còn " + (2000 - player.NguHanhSonPoint) + " điểm nữa");
                            }
                        }
                        if (select == 3) {
